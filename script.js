...
// --- Helper Function: Count Categories in List ---
function countCategoriesInList(numbersList) {
let firstDozen = 0;
let secondDozen = 0;
let thirdDozen = 0;
let lowNumbers = 0; // 1-18
let highNumbers = 0; // 19-36

for (const number of numbersList) {
// Only process numbers 1-36 for these categories
...
// Numbers 0 and "00" are skipped from these specific counts.
}

return {
firstDozen: firstDozen,
secondDozen: secondDozen,
thirdDozen: thirdDozen,
...
categoryCountsOutput.textContent = ""; // Clear new output too
...
// --- Count Categories in Surrounding Numbers ---
